        ...
        <footer>
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm sm:text-center">© {new Date().getFullYear()} <a href="https://www.suncoast.systems" className="hover:underline">Suncoast Systems</a>. All Rights Reserved.
                    </span>
                    <div className="flex mt-4 sm:justify-center sm:mt-0">
                        ...
                        <a href="https://github.com/dotcomrow" className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
